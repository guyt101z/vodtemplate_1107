    ...
    <script language="javascript">
    	...
    	function keyEvent(keyCode) {
    		if(keyCode == KEY_ENTER || keyCode == KEY_BACK){
    				window.parent.location.href="/vod/moviehouse/en/ppv/grid_view.jsp?lang=zh_tw";
						//window.parent.location.href="http://visvod.netvigator.com/jsp/en/svod/sd_landing_mh.jsp";
    		}
    	}
    </script>
</head>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td>
                            ...
                            <tr>
                                    <td width="" height="109" class=" txt01 paddingLeft18">Sorry, the viewing period is expired.</td>
                              </tr>
                            </table>                        
