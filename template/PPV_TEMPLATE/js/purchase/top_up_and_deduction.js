function topUpAndDeductionInit(){
	document.getElementById("body_content").innerHTML = topUpAndDeduction_body_content;
	if (!isNaN(cur_cash_point)) {
		document.getElementById("remaining_cash_point").innerHTML = purchase_txt_04+(parseFloat(cur_cash_point)+parseFloat(planlist_arr[cur_option+option_offset-1].cashPoint)-cashpoint);
	}
	else {
	...
	pinInit();
	status = "top_up_and_deduction";
	next_status = "thankyou";
	prev_status = "select_plan";
}

var topUpAndDeduction_body_content = 
"
...
<tr style='background-image:url(../../images/time_remain_bar_middle.png);'>
<td width='295' height='32' class='txt02 paddingLeft18'>"+purchase_txt_16+"</td>
...
<tr>
<td width='' height='2' colspan='2' class=''></td>
</tr>
</table>
</td>
</tr>
