...
<head>
    ...
    <link href="css/mh_style_e_test.css" rel="stylesheet" type="text/css">
                    ...
                    <tr>
                      <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="474" height="32" align="right">
                              <tr>
                              <td width="" height="17" class="txt01">FOX PPV CPOPSVODoPoD 12px</td>
                              </tr>
                              <tr>
                              <td width="" height="17" class="txt02">FOX PPV CPOPSVODoPoD 14px</td>
                              </tr>
                              <tr>
                              <td width="" height="17" class="txt03">FOX PPV CPOPSVODoPoD 16px</td>
                              </tr>
                              <tr>
                              <td width="" height="17" class="txt04">FOX PPV CPOPSVODoPoD 18px</td>
                              </tr>
                            </table>
