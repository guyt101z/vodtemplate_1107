...
<head>
    ...
    <script language="javascript" src="js/purchase.js"></script>
</head>
                    ...
                    <tr>
                      <td height="">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td width="310" height="32" class="txt02 paddingLeft18">Price:</td>
                                    <td id="price" width="164" height="32" class="txt01"></td>
                                </tr>
                                <tr>
                                    <td width="310" height="32" class="txt02 paddingLeft18"></td>
...
unlimited viewing within this 48-hour period.</td>
                                ...
                                <tr>
                                    <td width="310" height="2" class="txt02 paddingLeft18"></td>
                                    <td width="164" height="2" class="txt01"></td>
                                </tr>
                                <tr>
                                    <td width="" height="1" colspan="2" class=""></td>
                                </tr>
                                <tr>
                                    <td width="" height="61" colspan="2" class="txtInvalid paddingLeft18 paddingRight50"><!--Sorry, you have subscribed to SD service plan.<br>To upgrade to the HD service plan, please call our 24-hour sales hotline at 1000 (then press 1) for more information.--></td>
                                </tr>
                            </table>    
                        </td>
                    </tr>
                    <tr>
                    	<td>
                            <table width="474" border="0" cellpadding="0" cellspacing="0" align="right">
                                <tr>
                                    <td height="32" colspan="2"><span class="paddingLeft18 txtInfo02">(Non-refundable after subscription is confirmed)</span></td>
                                </tr>
                                <tr>
                                    <td height="44" width="268" class="paddingLeft18">Please input PIN and press ENTER to continue</td>
