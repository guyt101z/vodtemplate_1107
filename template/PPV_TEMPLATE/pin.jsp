...
<head>
    ...
    <script language="javascript">
    	var backURL = "<%=backURL%>";
			var urlparam = "movieDuration=<%=movieDuration%>&expdayval=<%=expDayVal%>&cat=<%=cat%>&productid=<%=productId%>&movieformat=<%=movieFormat%>&purchaseother=<%=purchaseOther%>&<%=urlParam%>";
