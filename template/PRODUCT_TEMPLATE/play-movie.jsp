...
var stopURL = "http://" + afterplayip + "/vodtemplate/template/PRODUCT_TEMPLATE/after-play.jsp?mode=stop&bitrate="+bitrate+"&"+urlParam;
var powerOffURL = "http://" + afterplayip + "/vodtemplate/template/PRODUCT_TEMPLATE/after-play.jsp?mode=poweroff&bitrate="+bitrate+"&"+urlParam;
var endURL = "http://" + afterplayip + "/vodtemplate/template/PRODUCT_TEMPLATE/after-play.jsp?mode=end&bitrate="+bitrate+"&"+urlParam;
var timeLimitReachedURL = "http://" + afterplayip + "/vodtemplate/template/PRODUCT_TEMPLATE/after-play.jsp?mode=overtime&bitrate="+bitrate+"&"+urlParam;
var errorURL = "http://" + afterplayip + "/vodtemplate/template/PRODUCT_TEMPLATE/after-play.jsp?bitrate="+bitrate+"&"+urlParam;
