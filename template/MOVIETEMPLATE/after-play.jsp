...
<%
	...
	String playNextURL = "http://" + afterplayip + "/vodtemplate/template/MOVIETEMPLATE/checkFlags.jsp?"+urlParam+"&cat="+cat+"&seriesid="+seriesId+"&seriesproductid="+nextSeriesProductId+"&scheduleid="+nextSeriesScheduleId;
	String seriesDetailPageURL = "http://" + afterplayip + "/vodtemplate/template/MOVIETEMPLATE/detail.jsp?"+urlParam+"&cat="+cat+"&seriesid="+seriesId+"&seriesproductid="+seriesProductId;
